<%-- 
    Document   : tabla_juridica
    Created on : 28 jun. 2023, 17:21:54
    Author     : Admin
--%>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1> DATOS INGRESADOS EN LA BUSQUEDA DE LA VISTA ANTERIOR </h1>
                </section>
                <!-- Content Header (Page header) -->
                <section class="content-header">
                    <a href="srvSunarp?accion=leer_juridica" class="btn btn-success">
                    ...
                    <div class="box">    
                        ...
                        <div class="box-body">
                            <div class="table-responsive" >                                 
                                <table class="table table-bordered table-striped dataTable table-hover" id="tablaMultiJuridica" class="display">
                                    <thead>
                                        <tr>
                                            <th>Indice</th>
                                    ...
                                    <!-- comment -->
                                    <c:forEach var="emp" items="${empresa}" varStatus="iteracion">                                                    
                                        <tr>
                                            ...
                                            <td><a href="<c:url value="srvSunarp">
                                                       <c:param name="accion" value="leer_juridica"/>
                                                       <c:param name="cod_1Juridica" value="${emp.tipoDocumento}"/>
                                                       <c:param name="cod_2Juridica" value="${emp.numeroDocumento}"/>
                                                       <c:param name="cod_3Juridica" value="${emp.razon}"/>
