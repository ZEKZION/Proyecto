<%-- 
    Document   : form_juridica
    Created on : 28 jun. 2023, 15:40:22
    Author     : Admin
--%>
            ...
            <div class="content-wrapper">
                ...
                <div class="box">    
                    ...
                    <div class="box-body">
                        ...
                        <form class="form-horizontal" action="srvSunarp?accion=busqueda_juridica" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input type="text" name="txtRazonSocial" class="form-control" required />
                                    </div>
                                </div>
