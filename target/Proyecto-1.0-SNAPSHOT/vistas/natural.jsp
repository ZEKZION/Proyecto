<%-- 
    Document   : natural
    Created on : 28 jun. 2023, 16:36:21
    Author     : Admin
--%>
                    ...
                    <div class="box">    
                        ...
                        <div class="box-body">
                            <div class="table-responsive" >                                 
                                <table class="table table-bordered table-striped dataTable table-hover" id="tablaNatural" class="display">
                                    <thead>
                                        <tr>
                                            <th>Indice</th>
                                            <th>Registro</th>
                                    ...
                                    <c:forEach var="bie" items="${bienes}" varStatus="iteracion">                                                    
                                        <tr>
                                            ...
                                            <td><a href="<c:url value="srvSunarp">
                                                       <c:param name="accion" value="mostrar_pdf"/>
                                                       <c:param name="cod_pdf" value="" />
                                                        ...
                                                        <a href="<c:url value="srvSunarp">
                                                       <c:param name="accion" value="vista_previa"/>
                                                       <c:param name="cod_pdf" value="" />
                                                   </c:url>"><button type="button" class="btn btn-info" data-toggle="tooltip"  title="Editar" data-original-title="Editar">
                                                        <i class="fa fa-file-text-o" aria-hidden="true"></i></button></a>
                                                        
                                                        <a href="#" onclick="openPDFPreview('')"><button type="button" class="btn btn-info" data-toggle="tooltip"  title="Editar" data-original-title="Editar">
    <i class="fa fa-file-text-o" aria-hidden="true"></i></button></a>

                                                        
<script>
  function openPDFPreview(cod_pdf) {
    window.open("srvSunarp?accion=vista_previa&cod_pdf=" + cod_pdf, "_blank");
  }
</script>
